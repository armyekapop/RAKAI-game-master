...
fish::fish(sf::Texture* texture, sf::Vector2u imageCount, float switchTime, float h, float w, float x, float y) :
...
void fish::update1(float deltaTime)
{
...
void fish::update2(float deltaTime, Player player)
{
...
void fish::updatefish1(float deltaTime)
{
...
void fish::updatefish2(float deltaTime, Player player)
{
...
void fish::OnCollision(sf::Vector2f direction)
{
    if (direction.x < 0.0f) {
        //left
        velocity.x = 0.0f;
